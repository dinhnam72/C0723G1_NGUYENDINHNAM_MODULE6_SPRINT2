...
export default function Header({setShowCart,customer}) {
                        ...
                        <div className="d-flex col-2 col-md-2">
                            ...
                            <div className="col-8">
                                <div onClick={onShowCartHandler} className="cart-icon">
                                    ...
                                    <span className="cart-quantity badge text-white ms-1 rounded-pill">{carts.length}</span>
                                </div>
                            </div>
                    ...
                    <div className="px-3 py-1 navbar123 text-white">
                        <div className="container d-flex align-items-center justify-content-center">
                            <ul className=" nav col-12  justify-content-center text-small">
                                <li>
                                    <NavLink role="button" onClick={offShowCartHandler} className="nav-link text-white">
                                        TRANG CHỦ
                                    </NavLink>
                                </li>
                                <li>
